...
<main>
  <section>
    ...
    <div align="left">
      ...
      <img src="https://img.shields.io/badge/JavaScript-F7DF1E?style=flat&logo=javascript&logoColor=black&labelColor=F7DF1E&color=white" alt="JavaScript"/>
  ...
  <section>
    ...
    <ul>
        <li><h4> <a href="https://github.com/SOKLY6/Project_safe_team" target="_blank">Система контроля доступа на закрытые территории с использованием QR-кодов</a></h4></li> 
        <span>
        В качестве frontend-разработчика и UI/UX дизайнера разработал веб-сервис для сотрудников организаций. 
        Реализовал интерфейсы для проверки QR-кодов, отображения детальной информации о посетителях и общей статистики посещений. 
        Полностью отвечал за проектирование интерфейса в Figma, клиентскую часть, дизайн, адаптивность и интеграцию с backend через REST-API.
        </span>
    </ul>
  </section>
  <section>
